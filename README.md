...
[Humio Log Shipper Cloudformation template](https://github.com/humio/cloudwatch2humio). Please file issues in the code
and infrastructure there unless the issue is related to terraform.
